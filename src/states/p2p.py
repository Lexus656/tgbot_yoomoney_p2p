from aiogram.types import Message, InlineKeyboardMarkup, InlLineKeyboardButton
...
async def p2p_buy(message: Message):
    ...
    claim_keyboard.add(InlineKeyboardButton(text='onnate!',
    url=quickpay.redirected_url))

    claim_keyboard.add(InlineKeyboardButton(text=' fonyyuts Tosap!',
